...
const Contract = () => {
  return (
    <section className='relative w-full h-[300px]' style={{ backgroundImage: "url('/bg1.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <h1 className='w-auto text-5xl font-bold mx-auto'>CONTRACT ID</h1>
            </div>
            <div className='flex flex-col w-[650px] h-auto mx-auto mt-5'>
            <div className='w-auto h-auto flex flex-row border-2 rounded-2xl m-auto p-5 bg-cyan-600-700/10 shadow-lg border-cyan-200/80 '>
                <h1 className='text-4xl font-bold text-white transition-all duration-300 ease-in-out hover:scale-105 hover:border-l-green-500 hover:animate-pulse hover:text-cyan-300'>ID: 00000000000000000000</h1>
                <button className='rounded-2xl bg-cyan-500 text-white ml-7 p-3 uppercase font-bold cursor-pointer transition-all duration-300 ease-in-out hover:scale-105 hover:border-l-green-500 hover:animate-pulse hover:text-white' onClick={() => copyToClipboard('0000000000000')}>COPY ID</button>
            </div>
